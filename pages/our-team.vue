...
import JonRowand from '/img/bio/JMRowandSquare2024_-_Edited_1.jpg'
import WyattBest from '/img/bio/Wyatt_Best.png'
import BinhRowand from '/img/bio/Binh_Rowand_-_Edited_1.png'
import MeganStory from '/img/bio/Megan_Story_1.png'
import PeterMcKay from '/img/bio/Peter_McKay.png'
import IsaacBest from '/img/bio/Isaac_Best.png'
