...
const JonRowand = publicAssetsURL("/img/bio/JMRowandSquare2024_-_Edited_1.jpg");
const WyattBest = publicAssetsURL("/img/bio/Wyatt_Best.png");
const BinhRowand = publicAssetsURL("/img/bio/Binh_Rowand_-_Edited_1.png");
const MeganStory = publicAssetsURL("/img/bio/Megan_Story_1.png");
const PeterMcKay = publicAssetsURL("/img/bio/Peter_McKay.png");
const IsaacBest = publicAssetsURL("/img/bio/Isaac_Best.png");
const _sfc_main = {
  __name: "our-team",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "py-12" }, _attrs))} data-v-f33b667c><img${ssrRenderAttr("src", _imports_0)} alt="rew" class="bg-logo !top-1/2 !left-1/2 !transform -translate-x-1/2 !-translate-y-1/2 hidden md:block mt-[150px]" data-v-f33b667c><div data-aos="fade-down" class="flex items-center justify-center mb-12 heading" data-v-f33b667c> The <img${ssrRenderAttr("src", _imports_0$1)} alt="ReWorkflow" width="231" height="30" class="mx-2 ps-1" data-v-f33b667c> Team </div><div class="container-fluid !max-w-[1000px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12" data-v-f33b667c><!--[-->`);
      ssrRenderList(unref(bios), (bio, index) => {
        _push(`<div data-aos="zoom-in-down" data-aos-offset="50"${ssrRenderAttr("data-aos-delay", index * 50)} data-v-f33b667c>`);
...
const ourTeam = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f33b667c"]]);

export { ourTeam as default };
//# sourceMappingURL=our-team-xZiF6ZXk.mjs.map
